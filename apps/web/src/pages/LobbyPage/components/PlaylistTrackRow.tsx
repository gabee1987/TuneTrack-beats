...
function PlaylistTrackContent({
  ...
  return (
    <>
      {canSelect ? (
        <SelectableArtwork
          ariaLabel={t("lobby.playlist.toggleSelection", { title: track.title })}
          isSelected={isSelected}
          onToggle={onToggleSelect}
        >
          {track.artworkUrl ? <SelectableArtworkImage src={track.artworkUrl} /> : <MusicNoteIcon />}
        </SelectableArtwork>
      ) : (
        <StaticArtwork>
          {track.artworkUrl ? <SelectableArtworkImage src={track.artworkUrl} /> : <MusicNoteIcon />}
      ...
      <button className={styles.trackOpenButton} onClick={onOpen} type="button">
        ...
        <span className={styles.trackBadges}>
