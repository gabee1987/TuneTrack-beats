                      ...
                      {activeTab?.id === "view" ? (
                        <div className={styles.section}>
                          ...
                          <div className={styles.fieldGroup}>
                            ...
                            <label className={styles.toggleField}>
                              <div className={styles.toggleCopy}>
                                <span className={styles.toggleLabel}>Show phase</span>
                                <span className={styles.toggleHint}>
                        ...
                        <div className={styles.section}>
                          ...
                          <div className={styles.fieldGroup}>
                            ...
                            <label className={styles.toggleField}>
                              <div className={styles.toggleCopy}>
                                <span className={styles.toggleLabel}>Year</span>
                              </div>
                              <input
                                checked={showDevYearInfo}
                                className={styles.checkbox}
                                onChange={(event) =>
                                  setDevVisibility({
                                    showDevYearInfo: event.target.checked,
                                  })
                                }
                                type="checkbox"
                              />
